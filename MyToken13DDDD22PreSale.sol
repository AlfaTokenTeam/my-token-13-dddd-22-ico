...
import "./MyToken13DDDD22.sol";

contract MyToken13DDDD22PreSale {
    MyToken13DDDD22 public token;
    ...
    function MyToken13DDDD22PreSale(
        MyToken13DDDD22 _token,
        address _beneficiary,
        address _alfatokenteam
    ) {
        token = MyToken13DDDD22(_token);
